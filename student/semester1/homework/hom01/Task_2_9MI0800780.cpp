...
// Може ли да ползваме функция за четене на цял ред от конзолата за 3 зад?
// Може ли да ползваме srand(time(0)) във 2 зад?
// Може ли да ползваме проверка от вида if(cin >> n) за валидация на входни данни?
// Може ли да имаме вложени цикли при обхождане на матрицата във 2 зад?
// Грешен ли е примерът в 3 зад?